...
public class Tenant {
    ...
    private HashMap<String, Messages> mConvos;
 ...
 */
    ...
    public HashMap<String, Messages> getmConvos() { return mConvos;}

    public void setmConvos(HashMap<String, Messages> mConvos) {
        this.mConvos = mConvos;
    }

    public Messages getMessages(String name) { return mConvos.get(name);}
